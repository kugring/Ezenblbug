                    ...
                    <c:forEach var="vo" items="${mainGetViewProject}">
                        <div class="attention-card">
                            ...
                            <div class="attention-card-body">
                                ...
                                <div class="attention-card-progress-rate">
                                    <fmt:formatNumber value="${(vo.totalDonation / vo.goalBudget) * 100}" type="number" maxFractionDigits="0" />% 달성
                                </div>
                            </div>
                ...
                <c:forEach var="vo" items="${mainGetFavoriteProject}"
                    ...
                    <div class="hit-box-bundle">
                        ...
                        <div class="hit-text-box">
                            ...
                            <div class="hit-text-box-percentage"><fmt:formatNumber value="${(vo.totalDonation / vo.goalBudget) * 100}" type="number" maxFractionDigits="0" />% 달성
                            </div>
                        </div>
                        <input name="project-id" type="hidden"
                               value="${vo.getProjectId()}">
